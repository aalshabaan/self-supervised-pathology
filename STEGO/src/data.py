...
class DirectoryDataset(Dataset):
    def __init__(self, root, path, image_set, transform, target_transform, im_loader=None):
    ...
    def __getitem__(self, index):
        ...
        img = Image.open(join(self.img_dir, image_fn)) if self.im_loader is None else self.im_loader(join(self.img_dir, image_fn))
...
class ContrastiveSegDataset(Dataset):
    def __init__(self,
        ...
        if dataset_name == "potsdam":
            ...
            extra_args = dict(path=cfg.dir_dataset_name, im_loader=im_loader)
